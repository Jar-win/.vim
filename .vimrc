...
" Save with Ctrl + S <this is after the habit I picked from Atom> :(
" Ctrl+S is a common command to terminals to stop updating it.
" Before, this work I also added the given alias to zsh.
